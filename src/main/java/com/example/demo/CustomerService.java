...
public class CustomerService {
	...
	@Produces(MediaType.TEXT_PLAIN)
	public String updateCustomer(@FormParam("cID") String cID,@FormParam("cName") String cName,@FormParam("cAddress") String cAddress,@FormParam("pName") String pName,@FormParam("cEmail") String cEmail,@FormParam("cDate") String cDate,@FormParam("cGender") String cGender,@FormParam("cPno") String cPno)
	{
	...
	// String cPno = customerObject.get("cPno").getAsString();
	 String output = customerObj.updateCustomer(cID, cName, cAddress, pName, cEmail, cDate, cGender, cPno);
	return output;
	}
	...
	@Produces(MediaType.TEXT_PLAIN)
	public String deleteCustomer(@FormParam("cID") String cID)
	{
